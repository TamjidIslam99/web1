  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <Link class="nav-link" to="Cinfo34">Book Reference</Link>
        </li>
        <li class="nav-item">
          <Link class="nav-link" to="Cinfo54">Course Content Outline</Link>
        </li>
        <li class="nav-item">
          <Link class="nav-link" to="Cinfo44">Guided Learning</Link>
        </li>
      </ul>
    </div>
  </div>
